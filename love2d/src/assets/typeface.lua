...
-- G: sweeps from the upper-right terminal all the way round to the right at
-- half height, where the bar turns in at a clean 90 degrees.
G("G", 0.71, { cat(arc(MX, 0.5, RX, RY, d2r(302), 0, 32), 0.285, 0.5) })
...
-- X: the same joint as K -- the two diagonals step past each other through a
-- short vertical instead of crossing at a point.
G("X", 0.70, {
  { 0.05, 0, 0.285, 0.435, 0.285, 0.565, 0.05, 1 },
  { 0.575, 0, 0.335, 0.435, 0.335, 0.565, 0.575, 1 },
})
