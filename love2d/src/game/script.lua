...
S.ending = {
  steps = {
    wait(2.4),
    line("botA", "it is quiet", "small", { auto = 2.0 }),
    wait(1.4),
    line("botB", "look at it", "soft", { auto = 2.2 }),
    wait(1.2),
    line("human", "The air is back.", "tired", { auto = 2.2 }),
    wait(0.9),
    line("botA", "you can take it off now", "soft", { auto = 2.6 }),
    wait(1.6),
    line("human", "The world is safe.", "flat", { auto = 2.4 }),
    wait(0.8),
    line("human", "I do not need this any more.", "flat", { auto = 1.8 }),
